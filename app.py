...
def check_missed_doses():
    # Reminder 10 mins before dose
    
    msg = f"⏰ Reminder: Take {med.get('name')} at {scheduled_tm}"
    send_sns_alert(msg)
...
def mark_taken(med_id):
    ...
    try:
        ...
        # Note: If log_date is your Sort Key, move it to KeyConditionExpression for better performance
